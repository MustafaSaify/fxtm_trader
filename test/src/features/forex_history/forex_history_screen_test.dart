...
void main(dynamic timestamp) {
  ...
  ForexHistoryDisplayModel displayModelMock =
  ...
  setUp(() {
    ...
    registerFallbackValue(
        ForexHistoryLoaded(displayModelMock)); // Add your model as necessary
  ...
  group('ForexHistoryScreen', () {
    ...
    testWidgets('shows content when state is ForexHistoryLoaded',
      ...
      when(() => mockBloc.state).thenReturn(ForexHistoryLoaded(displayModelMock));
      await pumpForexHistoryScreen(tester);
